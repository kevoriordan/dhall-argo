{ amqp :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.AMQPEventSource.dhall
...
, azureEventsHub :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.AzureEventsHubEventSource.dhall
...
, bitbucket :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.BitbucketEventSource.dhall
...
, bitbucketserver :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.BitbucketServerEventSource.dhall
...
, calendar :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.CalendarEventSource.dhall
...
, emitter :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.EmitterEventSource.dhall
...
, file :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.FileEventSource.dhall
...
, generic :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.GenericEventSource.dhall
...
, github :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.GithubEventSource.dhall
...
, gitlab :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.GitlabEventSource.dhall
...
, hdfs :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.HDFSEventSource.dhall
...
, kafka :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.KafkaEventSource.dhall
...
, minio :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.S3Artifact.dhall
...
, mqtt :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.MQTTEventSource.dhall
...
, nats :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.NATSEventsSource.dhall
...
, nsq :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.NSQEventSource.dhall
...
, pubSub :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.PubSubEventSource.dhall
...
, pulsar :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.PulsarEventSource.dhall
...
, redis :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.RedisEventSource.dhall
...
, redisStream :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.RedisStreamEventSource.dhall
...
, resource :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.ResourceEventSource.dhall
...
, slack :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.SlackEventSource.dhall
...
, sns :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.SNSEventSource.dhall
...
, sqs :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.SQSEventSource.dhall
...
, storageGrid :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.StorageGridEventSource.dhall
...
, stripe :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.StripeEventSource.dhall
...
, webhook :
    Optional
      ( List
          { mapKey : Text
          , mapValue :
              ./io.argoproj.events.v1alpha1.WebhookEventSource.dhall
