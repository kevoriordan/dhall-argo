...
, file :
    Optional
      ./io.argoproj.events.v1alpha1.FileArtifact.dhall
        sha256:32e7fda1f3ca2693794ac65e8aebb7e2bd2df5983f00224bd93a94e1cbdd7420
, git :
    Optional
      ./io.argoproj.events.v1alpha1.GitArtifact.dhall
        sha256:4e3a9811ffb9f1ca2e7c1b3b999dd7cede581f3b194085394f7ec4e787f0647a
, inline : Optional Text
, resource :
    Optional
      ./io.argoproj.events.v1alpha1.Resource.dhall
...
, url :
    Optional
      ./io.argoproj.events.v1alpha1.URLArtifact.dhall
